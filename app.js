...
var STORY_MAP_IMAGES = [
  "assets/coaches/subedhar-yadav.jpeg",
...
const realData = {
  ...
  coaches: [
    ...
    { name: "Shivajeet Kanaujiya", role: "Fitness Trainer", slug: "shivajeet-kanaujiya", category: "fitness", bio: "Fitness Trainer", focus: ["Fitness training", "Strength", "Daily exercise"], highlight: "Strength Builder", color: "red", image: "assets/coaches/shivajeet-kanaujiya.jpg" },
    { name: "Anand Yadav", role: "Children's Athletics Coach", slug: "anand-yadav", category: "kids", bio: "Children's Athletics Coach", focus: ["Children's athletics", "Kids fitness", "Sports"], highlight: "Kids Fitness Expert", color: "blue", image: "assets/coaches/anand-yadav.jpeg" },
    { name: "Aditya", role: "Yoga Instructor & Fitness Coach", slug: "aditya", category: "yoga", bio: "Yoga Instructor & Fitness Coach", focus: ["Yoga", "Fitness", "Body toning"], highlight: "Mind-Body Coach", color: "cyan", image: "assets/coaches/aditya.jpg" },
    { name: "Nitu Arya", role: "Yoga Instructor", slug: "nitu-arya", category: "yoga", bio: "Yoga Instructor", focus: ["Yoga", "Flexibility", "General fitness"], highlight: "Holistic Yoga", color: "cyan", image: "assets/coaches/nitu-arya.jpeg" },
    { name: "Rahul Bisht", role: "Yoga Instructor", slug: "rahul-bisht", category: "yoga", bio: "Yoga Instructor", focus: ["Yoga", "Mobility", "General fitness"], highlight: "Mobility Master", color: "cyan", image: "assets/coaches/rahul-bisht.jpeg" },
    ...
    { name: "Rahul Dawar", role: "Fitness Trainer", slug: "rahul-dawar", category: "fitness", bio: "Fitness Trainer", focus: ["Fitness training", "Strength", "Health routine"], highlight: "Health & Strength", color: "red", image: "assets/coaches/rahul-dawar.jpg" },
    { name: "Rahul Singh Pawar", role: "Yoga Instructor", slug: "rahul-singh-pawar", category: "yoga", bio: "Yoga Instructor", focus: ["Yoga", "Flexibility", "Stress relief"], highlight: "Stress Relief Expert", color: "cyan", image: "assets/coaches/rahul-singh-pawar.jpg" },
    { name: "Ravi Pal", role: "Fitness Trainer & Injury Rehabilitation Coach", slug: "ravi-pal", category: "rehab", bio: "Fitness Trainer & Injury Rehabilitation Coach", focus: ["Fitness training", "Injury rehabilitation", "Recovery"], highlight: "Injury Recovery", color: "blue", image: "assets/coaches/ravi-pal.jpg" },
    
    { name: "Sanjeev", role: "Fitness Trainer", slug: "sanjeev", category: "fitness", bio: "Fitness Trainer", focus: ["Fitness training", "Strength", "Daily exercise"], highlight: "Strength Trainer", color: "red", image: "assets/coaches/sanjeev.jpg" },
    { name: "Nandlal", role: "Fitness Trainer", slug: "nandlal", category: "fitness", bio: "Fitness Trainer", focus: ["Fitness training", "Strength", "Weight loss"], highlight: "Transformation Coach", color: "red", image: "assets/coaches/nandlal.jpg" },
    { name: "Prasenjit Ghosh", role: "Mudgar & Hybrid Training Specialist", slug: "prasenjit-ghosh", category: "hybrid", bio: "Mudgar & Hybrid Training Specialist", focus: ["Mudgar", "Hybrid training", "Strength"], highlight: "Hybrid Training", color: "cyan", image: "assets/coaches/prasenjit-ghosh.jpeg" },
    ...
    { name: "Parul Danu", role: "Yoga Instructor", slug: "parul-danu", category: "yoga", bio: "Yoga Instructor", focus: ["Yoga", "Flexibility", "Stress relief"], highlight: "Yoga & Wellness", color: "cyan", image: "assets/coaches/parul-danu.jpeg" },
    ...
    { name: "Vishal Choudhary", role: "Fitness Trainer", slug: "vishal-choudhary", category: "fitness", bio: "Fitness Trainer", focus: ["Fitness training", "Strength", "Personal training"], highlight: "Personal Training Pro", color: "red", image: "assets/coaches/vishal-choudhary.jpeg" },
...
function renderServices(services) {
  ...
  var imgMap = {
    ...
    prime: "assets/coaches/prasenjit-ghosh.jpeg",
...
var FALLBACK_COACHES = [
  ...
  { name: "Kritika Chauhan", role: "Fitness Trainer", slug: "kritika-chauhan", category: "fitness", bio: "Fitness Trainer specializing in flexibility, mobility, and general fitness.", focus: ["Flexibility", "Mobility", "General fitness"], highlight: "Flexibility Coach", color: "red", image: "assets/coaches/kritika-chauhan.jpg" },
  { name: "Nitu Arya", role: "Yoga Instructor", slug: "nitu-arya", category: "yoga", bio: "Yoga Instructor focused on holistic wellness and flexibility.", focus: ["Yoga", "Flexibility", "General fitness"], highlight: "Holistic Yoga", color: "cyan", image: "assets/coaches/b-yashwanth.jpg" },
  { name: "Rahul Bisht", role: "Yoga Instructor", slug: "rahul-bisht", category: "yoga", bio: "Yoga Instructor specializing in mobility and general fitness.", focus: ["Yoga", "Mobility", "General fitness"], highlight: "Mobility Master", color: "cyan", image: "assets/coaches/rahul-bisht.jpeg" },
  { name: "Anand Yadav", role: "Children's Athletics Coach", slug: "anand-yadav", category: "kids", bio: "Children's Athletics Coach focused on kids fitness and sports development.", focus: ["Children's athletics", "Kids fitness", "Sports"], highlight: "Kids Fitness Expert", color: "blue", image: "assets/coaches/anand-yadav.jpeg" },
  { name: "Ravi Pal", role: "Fitness Trainer & Injury Rehabilitation Coach", slug: "ravi-pal", category: "rehab", bio: "Fitness Trainer & Injury Rehabilitation Coach.", focus: ["Fitness training", "Injury rehabilitation", "Recovery"], highlight: "Injury Recovery", color: "blue", image: "assets/coaches/ravi-pal.jpg" },
  { name: "Subedhar Yadav", role: "Fitness Trainer (Special Children)", slug: "subedhar-yadav", category: "special", bio: "Fitness Trainer for special children focusing on mobility and strength.", focus: ["Special children", "Fitness", "Mobility"], highlight: "Special Needs Coach", color: "blue", image: "assets/coaches/subedhar-yadav.jpeg" },
  { name: "Prasenjit Ghosh", role: "Mudgar & Hybrid Training Specialist", slug: "prasenjit-ghosh", category: "hybrid", bio: "Mudgar & Hybrid Training Specialist for functional strength.", focus: ["Mudgar", "Hybrid training", "Strength"], highlight: "Hybrid Training", color: "cyan", image: "assets/coaches/prasenjit-ghosh.jpeg" },
];
...
async function emailLeadViaFormSubmit(payload) {
  ...
  var formPayload = {
    ...
    _subject: "[Fitness Gurukul] New " + label + " — " + name,
    _template: "table",
    _captcha: "false",
    _replyto: replyTo,
  };
...
function initCycleCarousel() {
  ...
  var slides = [
    ...
    { img: "assets/coaches/subedhar-yadav.jpeg", caption: "Ride & Pose 2025 � Yoga Day Sunrise Ride at Narsingi", link: "https://www.instagram.com/p/DZoWDw4jyt6/" },
...
(function() {
  var coachData = {
    "aditya-gururani": { name:"Aditya Gururani", role:"Yoga Instructor & Breathing Specialist", badge:"Breathwork Expert", img:"assets/coaches/aditya-gururani.jpg", tags:["Breathwork","Stress management","Functional mobility"] },
    "b-yashwanth": { name:"B Yashwanth", role:"Basketball Coach", badge:"Sports Specialist", img:"assets/coaches/b-yashwanth.jpg", tags:["Basketball","Sports coaching","Conditioning"] },
    "kritika-chauhan": { name:"Kritika Chauhan", role:"Fitness Trainer", badge:"Flexibility Coach", img:"assets/coaches/kritika-chauhan.jpg", tags:["Flexibility","Mobility","General fitness"] },
    "shivajeet-kanaujiya": { name:"Shivajeet Kanaujiya", role:"Fitness Trainer", badge:"Strength Builder", img:"assets/coaches/shivajeet-kanaujiya.jpg", tags:["Fitness training","Strength","Daily exercise"] },
    "anand-yadav": { name:"Anand Yadav", role:"Children's Athletics Coach", badge:"Kids Fitness Expert", img:"assets/coaches/anand-yadav.jpeg", tags:["Children's athletics","Kids fitness","Sports"] },
    "aditya": { name:"Aditya", role:"Yoga Instructor & Fitness Coach", badge:"Mind-Body Coach", img:"assets/coaches/aditya.jpg", tags:["Yoga","Fitness","Body toning"] },
    "nitu-arya": { name:"Nitu Arya", role:"Yoga Instructor", badge:"Holistic Yoga", img:"assets/coaches/nitu-arya.jpeg", tags:["Yoga","Flexibility","General fitness"] },
    "rahul-bisht": { name:"Rahul Bisht", role:"Yoga Instructor", badge:"Mobility Master", img:"assets/coaches/rahul-bisht.jpeg", tags:["Yoga","Mobility","General fitness"] },
    "deepesh-kumar": { name:"Deepesh Kumar", role:"Fitness Trainer", badge:"Weight Loss Specialist", img:"assets/coaches/deepesh-kumar.jpg", tags:["Fitness training","Strength","Weight loss"] },
    "s-jeetender": { name:"S Jeetender", role:"Fitness Trainer", badge:"Daily Fitness Pro", img:"assets/coaches/s-jeetender.jpg", tags:["Fitness training","Daily exercise","Strength"] },
    "rahul-dawar": { name:"Rahul Dawar", role:"Fitness Trainer", badge:"Health & Strength", img:"assets/coaches/rahul-dawar.jpg", tags:["Fitness training","Strength","Health routine"] },
    "rahul-singh-pawar": { name:"Rahul Singh Pawar", role:"Yoga Instructor", badge:"Stress Relief Expert", img:"assets/coaches/rahul-singh-pawar.jpg", tags:["Yoga","Flexibility","Stress relief"] },
    "ravi-pal": { name:"Ravi Pal", role:"Fitness Trainer & Injury Rehab Coach", badge:"Injury Recovery", img:"assets/coaches/ravi-pal.jpg", tags:["Fitness training","Injury rehabilitation","Recovery"] },
    "subedhar-yadav": { name:"Subedhar Yadav", role:"Fitness Trainer (Special Children)", badge:"Special Needs Coach", img:"assets/coaches/subedhar-yadav.jpeg", tags:["Special children","Fitness","Mobility"] },
    "sanjeev": { name:"Sanjeev", role:"Fitness Trainer", badge:"Strength Trainer", img:"assets/coaches/sanjeev.jpg", tags:["Fitness training","Strength","Daily exercise"] },
    "nandlal": { name:"Nandlal", role:"Fitness Trainer", badge:"Transformation Coach", img:"assets/coaches/nandlal.jpg", tags:["Fitness training","Strength","Weight loss"] },
    "prasenjit-ghosh": { name:"Prasenjit Ghosh", role:"Mudgar & Hybrid Training Specialist", badge:"Hybrid Training", img:"assets/coaches/prasenjit-ghosh.jpeg", tags:["Mudgar","Hybrid training","Strength"] },
    "vinay-ojha": { name:"Vinay Ojha", role:"Fitness Trainer", badge:"All-Round Fitness", img:"assets/coaches/vinay-ojha.jpg", tags:["Fitness training","Strength","General fitness"] },
    "ankit-singh-chauhan": { name:"Ankit Singh Chauhan", role:"Fitness & Calisthenics Trainer", badge:"Calisthenics Expert", img:"assets/coaches/ankit-singh-chauhan.jpg", tags:["Fitness","Calisthenics","Strength"] },
    "suresh-yadav": { name:"Suresh Yadav", role:"Fitness Trainer (Special Children)", badge:"Special Needs Expert", img:"assets/coaches/suresh-yadav.jpg", tags:["Special children","Fitness","Mobility"] },
    "parul-danu": { name:"Parul Danu", role:"Yoga Instructor", badge:"Yoga & Wellness", img:"assets/coaches/parul-danu.jpeg", tags:["Yoga","Flexibility","Stress relief"] },
    "raju": { name:"Raju", role:"Fitness Trainer", badge:"Fitness Guide", img:"assets/coaches/raju.jpg", tags:["Fitness training","Strength","Health routine"] },
    "vishal-choudhary": { name:"Vishal Choudhary", role:"Fitness Trainer", badge:"Personal Training Pro", img:"assets/coaches/vishal-choudhary.jpeg", tags:["Fitness training","Strength","Personal training"] }
  };
